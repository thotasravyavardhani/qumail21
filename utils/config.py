...
def load_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        'yahoo_client_id': os.getenv('YAHOO_CLIENT_ID', os.getenv('QUMAIL_YAHOO_CLIENT_ID', '')),
        'yahoo_client_secret': os.getenv('YAHOO_CLIENT_SECRET', os.getenv('QUMAIL_YAHOO_CLIENT_SECRET', '')),
        'outlook_client_id': os.getenv('OUTLOOK_CLIENT_ID', os.getenv('QUMAIL_OUTLOOK_CLIENT_ID', '')),
        'outlook_client_secret': os.getenv('OUTLOOK_CLIENT_SECRET', os.getenv('QUMAIL_OUTLOOK_CLIENT_SECRET', '')),
